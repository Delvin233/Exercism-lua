...
/*    else if (has_eaten_all_dots == true && power_pellet_active == false && touching_ghost == false){
        return true;
    }
    else if (has_eaten_all_dots == true && power_pellet_active == true && touching_ghost == true){
        return true;
    };
*/
    return false;
